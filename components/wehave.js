    ...
    <div key={idx} className="w-[130px] h-[100px] flex items-center justify-center">
      ...
      />
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-gray-700 font-normal text-sm mb-10 text-center">
            We Also Help AI Startups To Create MVP, Prototype & Fundraising Custom Solutions
          </p>
  
          <div className="w-[700px] bg-[#e6866e] rounded-md p-6 mb-10 ">
            <h3 className="text-white text-3xl md:text-4xl font-bold mb-4">Manyface</h3>
            <p className="text-white">Our Own Internationally Launched AI Product</p>
          </div>
          <Link
            href="/explore"
            className="inline-flex items-center bg-[#0D7A8A] text-white px-6 py-3 rounded-full hover:bg-[#0A6A78] transition-colors">
            Explore More
